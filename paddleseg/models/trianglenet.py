...
def visual(images):
    ...
    plt.savefig('output/trianglenet-with-transfer-simple/70.44/{}_side.png'.format(time.time()))
    plt.show()
...
class TriangleNetHead(nn.Layer):
    """
    ...
    def __init__(self,
        ...
        super(TriangleNetHead, self).__init__()
...
if __name__ == '__main__':
    ...
    model = TriangleNet(19, ResNet18_vd())
    model(x)
